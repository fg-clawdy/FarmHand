...
Locked direction lives in [`phase-2-and-architecture.md`](phase-2-and-architecture.md). Selfie earn is implemented; see [`phase-2-selfie.md`](phase-2-selfie.md).

- Chore earn / purgatory plants
