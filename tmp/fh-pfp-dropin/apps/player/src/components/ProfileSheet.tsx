...
export default function ProfileSheet({
  ...
  onClose: () => void;
  onPlayerUpdate?: (player: GardenPlayer) => void;
}) {
        ...
        <>
          <div className="profile-identity">
            <KidAvatar
              ...
              mascot={profile.player.mascot}
              avatarKind={profile.player.avatarKind}
              avatarPreset={profile.player.avatarPreset}
            ...
            <div>
              ...
              <button className="btn primary profile-change-pic" type="button" onClick={() => setPicker(true)}>
                Change picture
              </button>
            </div>
          </div>
