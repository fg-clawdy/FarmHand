...
export const CHORE_CATALOG: SeedChore[] = [
...

  {
    ...
    title: "Hang Backpack",
    emoji: "🎒",
    description: "Hang backpack where it belongs.",
    recurrence: "WEEKDAYS",
    timeOfDay: "AFTERNOON",
    priority: "HIGH",
    estimatedMinutes: 2,
  ...
  },
  {
    ...
    title: "Shoes on Rack",
    emoji: "👟",
    description: "Take off shoes and put them on the shoe rack.",
    recurrence: "WEEKDAYS",
    timeOfDay: "AFTERNOON",
    priority: "HIGH",
    estimatedMinutes: 2,
  ...
  {
    slug: "water-bottle-backpack",
    title: "Water Bottle in Backpack",
    emoji: "💧",
    description: "Empty and refill water bottle and put it back in the backpack.",
    recurrence: "WEEKDAYS",
    timeOfDay: "AFTERNOON",
    priority: "HIGH",
    estimatedMinutes: 3,
  ...
  },
  {
    ...
    emoji: "🍽️",
    description: "Empty the clean dishwasher and put dishes away.",
    recurrence: "DAILY",
    timeOfDay: "AFTERNOON",
    priority: "NORMAL",
    estimatedMinutes: 10,
  ...
  },
  {
    ...
    title: "Do Homework",
    emoji: "📚",
    description: "Do today's homework. Skip if there is none.",
    recurrence: "DAILY",
    timeOfDay: "AFTERNOON",
    priority: "HIGH",
    estimatedMinutes: 30,
  ...
  {
    slug: "clean-snack-mess",
    title: "Clean Up After Snack",
    emoji: "🍪",
    description: "Clean up after snack — crumbs, dishes, and wrappers.",
    recurrence: "DAILY",
    timeOfDay: "AFTERNOON",
    priority: "NORMAL",
    estimatedMinutes: 5,
