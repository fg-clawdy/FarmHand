...
export const PLAYFIELD_LAYOUT = {
  ...
  /**
   * Corkboard Job Board on a ground stake in front of the barn door, northeast
   * of the tractor, clear of the exhaust puff. Same hotspot class as Farm Store,
   * not a garden plot. Locked with Game Engineer (PR #1 HEAD 5df37fc).
   * Tap → Job Coach / family board (no PIN to browse); claim is PR #1.
   */
  jobBoardHit: { u0: 0.38, v0: 0.14, u1: 0.52, v1: 0.36 } satisfies UvRect,
  ...
  blockers: {
    ...
    jobBoard: { u0: 0.38, v0: 0.14, u1: 0.52, v1: 0.36 } satisfies UvRect,
  },
  gardens: [
    {
