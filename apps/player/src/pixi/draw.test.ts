...
test("camera 0.9 never crops the garden painting", () => {
  const square = cameraFit(1536, 1024, 1536, 1024, 0.9);
  assert.ok(Math.abs(square.scale - 0.9) < 1e-9);
  const wide = cameraFit(1920, 1080, 1536, 1024, 0.9);
