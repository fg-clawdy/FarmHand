  ...
  return (
    <div className="sheet-backdrop" onClick={onClose} role="presentation">
      <div className="sheet store-sheet" onClick={(e) => e.stopPropagation()}>
        ...
        <h2 className="sheet-title">Farm Store</h2>
        <p className="sheet-lede">The General Store is still getting its shelves stocked. Check back after the next wagon comes through.</p>
